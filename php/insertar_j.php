...
<html>
	...
	<body class="is-preload">
		...
		<!-- Page Wrapper -->
			<div id="page-wrapper">
				...
				<!-- Header -->
					<header id="header">
						<h1><a href="./ingreso_j.php" class="special after">Regresar</a></h1>
						<nav>
							<a href="#menu">Menu</a>
						</nav>
					</header>
	...
	$resultado = pg_query("SELECT * FROM Jornada WHERE CodigoJ='$codigo'");
	if(pg_fetch_array($resultado)) {
		echo "<p>Ya existe una jornada con el codigo ingresado</p>";
	} else {
		pg_query("INSERT INTO Jornada VALUES($codigo,'$nombre','$horain','$horaout')") or die("No fue posible realizar la consulta");
		echo "<p>La Jornada fue creada exitosamente</p>";
	}
