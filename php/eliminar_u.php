...
$query = "DELETE FROM Usuario WHERE Username='$Uname'";



$result = pg_query($query);
pg_query("REVOKE SELECT,INSERT,UPDATE,DELETE ON Permiso FROM $Uname");
pg_query("REVOKE SELECT ON Empleado FROM $Uname");
pg_query("DROP USER $Uname");
?>
