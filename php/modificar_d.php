							...
							<div class="wrapper">
								<div class="inner">
									...
									<section id="footer">
                                        ...
                                        <form action="Mod_d.php" method="POST"  onsubmit="return verificador()" name="form">
            ...
            ?>
											 ...
											 <div class='fields'>
										         <div class='field'>
                                                    ...
                                                    <?php echo $CodigoD?>
														<input type='hidden' min='1' name="CodigoD" id="CodigoD" value = '<?php echo $CodigoD?>'/>
													</div>
													<div class="field">
														<label for="Nombre">Nombre</label>
														<input type="text" name="NombreD" id="NombreD" value='<?php echo $NombreD ?>'/>
                                                    </div>
