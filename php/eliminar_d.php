	...
	<body class="is-preload">
		...
		<!-- Page Wrapper -->
			<div id="page-wrapper">
				...
				<!-- Header -->
					<header id="header">
						<h1><a href="./listar_d.php" class="special after">Regresar</a></h1>
						<nav>
							<a href="#menu">Menu</a>
						</nav>
					</header>
							...
							<ul class="links">
								...
								<li><div class="dropdown2">
									...
									<div class="dropdown2-content-tres">
									  <a href="../informacion_d.php">Informacion</a>
...
$CodigoD=$_GET["CodigoD"]; // instruccion para obtener parametros que se llenaron desde el formulario
$NombreD=$_GET["NombreD"];
$dbconn = pg_connect("host=localhost dbname=ProyectoCCV user=postgres password=12345")
    or die('No se ha podido conectar: ' . pg_last_error());

    $query = "DELETE FROM Departamento WHERE codigod = $CodigoD";
...
<p> Se le informa que el Departamento de <?php echo $NombreD ?> 
    a sido eliminado de la empresa Vector s.a  </p>
    <br>
    <br>
