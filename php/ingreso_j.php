							...
							<div class="wrapper">
								<div class="inner">
									...
									<section id="footer">
                                        ...
                                        <form action="insertar_j.php" method="POST"  onsubmit="return verificador()" name="form">
											 ...
											 <div class='fields'>
										         <div class='field'>
													<label for="codigo">Código</label>
														<input type="number"  name="codigo"    id="codigo" min="1" step="1"/>
													</div>
													<div class="field">
                                                    ...
                                                    <div class="field">
														...
														<input type="time" name="horain" id="horain" />
                                                    </div>
                                                    <div class="field">
														<label for="horaout">Hora de salida</label>
														<input type="time" name="horaout" id="horaout" />
                                                    </div>
